...
(earliest is 2019) and any dataset-loading code, not from memory.}
...
thereafter). A more detailed rent- and council-tax-nowcasting methodology is
documented separately (\texttt{docs/book/assumptions/rf-nowcasting-methodology.md},
\todo{summarize once read in full -- not yet reviewed for this outline}).
